...
def open_custom_gamma_menu_s1(app):
    ...
    def on_slider_change(idx, val):
        ...
        app.custom_gamma_sdr_r1[idx] = value
        app.custom_gamma_sdr_g1[idx] = value
        app.custom_gamma_sdr_b1[idx] = value
    ...
    for i in range(64):
        rgb_sliders[i].config(command=make_on_slider_callback(i, app.custom_gamma_sdr_r1, "rgb"))
